...
export default function InventoryFormPage() {
    ...
    const handleSaveAll = async () => {
        if (!window.confirm(`${forms.length}개의 재고 기록을 저장하시겠습니까?`)) return;
        ...
        try {
            ...
            const promises = forms.map(form => {
                ...
                return firestoreService.addInventoryLog({
                    branch: user.branch,
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 pb-20">
            <div className="flex items-center space-x-4">
                ...
                <h1 className="text-2xl font-bold text-gray-900">마감 재고 일괄 입력</h1>
            </div>
